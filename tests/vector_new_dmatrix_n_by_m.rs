...
fn test_vec() {
    ...
    let mat: Mat<f64> = vec.new_dmatrix_n_by_m(M);
...
fn test_nalgebra_dmatrix() {
    ...
    let mat: DMatrix<f64> = vec.new_dmatrix_n_by_m(M);
...
fn test_ndarray() {
    ...
    let mat: Array2<f64> = vec.new_dmatrix_n_by_m(M);
...
fn test_faer() {
    ...
    let mat: FMat<f64> = vec.new_dmatrix_n_by_m(M);

...
/// Subset of operations required by [`crate::real_field_operations::RealFieldOperations`] that are
/// defined by [`faer_traits::RefOps`].
///
...
/// [`crate::real_field_operations::RealFieldOperationsRem`] and
/// [`crate::real_field_operations::RealFieldOperations`] instead.
///

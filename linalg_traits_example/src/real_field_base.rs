//! Implements [`linalg_traits::real_field::RealFieldBase`] for [`crate::my_real::MyReal`].
...
impl RealFieldBase for MyReal {
    ...
    fn _partial_cmp(self, rhs: Self) -> Option<std::cmp::Ordering> {
        <f64 as PartialOrd>::partial_cmp(&self.x, &rhs.x)
    }
...
mod tests {
    use super::*;
    use linalg_traits::real_field::assert_real_field_operations;
    ...
    fn test_real_field_operations() {
        ...
        assert_eq!(-&MyReal::new(7.0), MyReal::new(-7.0));
    }
}
